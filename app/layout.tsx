...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ThemeProvider>
          <div className="pointer-events-none fixed z-0 top-[calc(-1*env(safe-area-inset-top))] right-[calc(-1*env(safe-area-inset-right))] bottom-[calc(-1*env(safe-area-inset-bottom))] left-[calc(-1*env(safe-area-inset-left))] bg-[#F0EAD6] dark:bg-[#162040]" />
          <div className="pointer-events-none fixed z-0 top-[calc(-1*env(safe-area-inset-top))] right-[calc(-1*env(safe-area-inset-right))] bottom-[calc(-1*env(safe-area-inset-bottom))] left-[calc(-1*env(safe-area-inset-left))] bg-[url('/Background2.png')] bg-cover bg-[center_36%] bg-no-repeat opacity-45 max-[640px]:bg-[center_62%] dark:bg-[url('/BackgroundDarkMode.png')] dark:opacity-40" />
          <div className="pointer-events-none fixed z-0 top-[calc(-1*env(safe-area-inset-top))] right-[calc(-1*env(safe-area-inset-right))] bottom-[calc(-1*env(safe-area-inset-bottom))] left-[calc(-1*env(safe-area-inset-left))] bg-[radial-gradient(circle_at_9%_16%,#fff1b6_0_0.5%,transparent_0.9%),radial-gradient(circle_at_25%_20%,#ffffff_0_0.45%,transparent_0.8%),radial-gradient(circle_at_76%_12%,#fff1b6_0_0.5%,transparent_0.9%),radial-gradient(circle_at_88%_22%,#ffffff_0_0.45%,transparent_0.8%)] dark:bg-[radial-gradient(circle_at_9%_16%,#2e3868_0_0.5%,transparent_0.9%),radial-gradient(circle_at_25%_20%,#28365a_0_0.45%,transparent_0.8%),radial-gradient(circle_at_76%_12%,#2e3868_0_0.5%,transparent_0.9%),radial-gradient(circle_at_88%_22%,#28365a_0_0.45%,transparent_0.8%)]" />
