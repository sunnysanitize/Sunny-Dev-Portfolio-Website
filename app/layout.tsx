    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ThemeProvider>
          ...
          <div className="relative z-10 min-h-screen overflow-x-hidden px-3 pb-20 pt-8 text-[#2a241c] transition-colors duration-300 dark:text-[#dee2ec] sm:px-5 sm:pb-40 sm:pt-12">
