  ...
  return (
    <>
      <AnimatePresence mode="sync" initial={false}>
        <motion.div
          key={`${pathname}-bar`}
          className="pointer-events-none fixed left-0 right-0 top-0 z-50 h-1 origin-left bg-[linear-gradient(90deg,#d7b65a_0%,#fff3c9_45%,#8d6b1f_100%)] shadow-[0_0_16px_rgba(215,182,90,0.6)] dark:bg-[linear-gradient(90deg,#444444_0%,#cccccc_45%,#111111_100%)] dark:shadow-[0_0_16px_rgba(200,200,200,0.3)]"
